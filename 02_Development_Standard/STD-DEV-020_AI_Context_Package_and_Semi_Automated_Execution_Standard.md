...
ChatGPT structures thinking and documents.
...
## 4. Standard Semi-Automated Pipeline
...
## 5. Tool Role Separation

| Tool | Main Role | Should Avoid |
|---|---|---|
| ChatGPT | Thinking, requirement structuring, CR drafting, MVP decomposition, document drafting, prompt preparation | Acting as the only source of truth after files are created |
...
## 8. AI Execution Guardrails

AI should not:

1. Add features outside the approved scope.
...
## 9. Required Output From AI Implementation Tasks
